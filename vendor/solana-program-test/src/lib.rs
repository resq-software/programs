...
fn get_invoke_context<'a, 'b>() -> &'a mut InvokeContext<'b, 'b> {
    ...
    unsafe { &mut *std::ptr::with_exposed_provenance_mut::<InvokeContext<'b, 'b>>(ptr) }
}
...
impl solana_sysvar_v4::program_stubs::SyscallStubs for SyscallStubs {
    fn sol_log(&self, message: &str) {
        <Self as solana_sysvar::program_stubs::SyscallStubs>::sol_log(self, message)
    }
    ...
    fn sol_invoke_signed(
        ...
        <Self as solana_sysvar::program_stubs::SyscallStubs>::sol_invoke_signed(
            self,
            instruction,
            account_infos,
            signers_seeds,
    ...
    fn sol_get_sysvar(
        ...
        <Self as solana_sysvar::program_stubs::SyscallStubs>::sol_get_sysvar(
            self,
            sysvar_id_addr,
            var_addr,
            offset,
    ...
    fn sol_get_clock_sysvar(&self, var_addr: *mut u8) -> u64 {
        <Self as solana_sysvar::program_stubs::SyscallStubs>::sol_get_clock_sysvar(self, var_addr)
    }

    fn sol_get_epoch_schedule_sysvar(&self, var_addr: *mut u8) -> u64 {
        <Self as solana_sysvar::program_stubs::SyscallStubs>::sol_get_epoch_schedule_sysvar(
            self,
            var_addr,
        )
    }
    ...
    fn sol_get_fees_sysvar(&self, var_addr: *mut u8) -> u64 {
        <Self as solana_sysvar::program_stubs::SyscallStubs>::sol_get_fees_sysvar(self, var_addr)
    }

    fn sol_get_rent_sysvar(&self, var_addr: *mut u8) -> u64 {
        <Self as solana_sysvar::program_stubs::SyscallStubs>::sol_get_rent_sysvar(self, var_addr)
    }

    fn sol_get_epoch_rewards_sysvar(&self, var_addr: *mut u8) -> u64 {
        <Self as solana_sysvar::program_stubs::SyscallStubs>::sol_get_epoch_rewards_sysvar(
            self,
            var_addr,
        )
    }
    ...
    fn sol_get_last_restart_slot(&self, var_addr: *mut u8) -> u64 {
        <Self as solana_sysvar::program_stubs::SyscallStubs>::sol_get_last_restart_slot(
            self,
            var_addr,
        )
    }
    ...
    fn sol_get_epoch_stake(&self, vote_address: *const u8) -> u64 {
        <Self as solana_sysvar::program_stubs::SyscallStubs>::sol_get_epoch_stake(
            self,
            vote_address,
        )
    }
    ...
    unsafe fn sol_memcpy(&self, dst: *mut u8, src: *const u8, n: usize) {
        unsafe {
            <Self as solana_sysvar::program_stubs::SyscallStubs>::sol_memcpy(self, dst, src, n)
        }
    }

    unsafe fn sol_memmove(&self, dst: *mut u8, src: *const u8, n: usize) {
        unsafe {
            <Self as solana_sysvar::program_stubs::SyscallStubs>::sol_memmove(self, dst, src, n)
        }
    }

    unsafe fn sol_memcmp(&self, s1: *const u8, s2: *const u8, n: usize, result: *mut i32) {
        unsafe {
            <Self as solana_sysvar::program_stubs::SyscallStubs>::sol_memcmp(
                self, s1, s2, n, result,
            )
        }
    }
    ...
    unsafe fn sol_memset(&self, s: *mut u8, c: u8, n: usize) {
        unsafe {
            <Self as solana_sysvar::program_stubs::SyscallStubs>::sol_memset(self, s, c, n)
        }
    }

    fn sol_get_return_data(&self) -> Option<(Pubkey, Vec<u8>)> {
        <Self as solana_sysvar::program_stubs::SyscallStubs>::sol_get_return_data(self)
    }

    fn sol_set_return_data(&self, data: &[u8]) {
        <Self as solana_sysvar::program_stubs::SyscallStubs>::sol_set_return_data(self, data)
    }

    fn sol_log_data(&self, fields: &[&[u8]]) {
        <Self as solana_sysvar::program_stubs::SyscallStubs>::sol_log_data(self, fields)
    }

    fn sol_get_processed_sibling_instruction(&self, index: usize) -> Option<Instruction> {
        <Self as solana_sysvar::program_stubs::SyscallStubs>::sol_get_processed_sibling_instruction(
            self, index,
        )
    }

    fn sol_get_stack_height(&self) -> u64 {
        <Self as solana_sysvar::program_stubs::SyscallStubs>::sol_get_stack_height(self)
    }
}
    ...
    fn setup_bank(
    ...
    ) {
        {
            ...
            ONCE.call_once(|| {
                ...
                solana_sysvar_v4::program_stubs::set_syscall_stubs(Box::new(SyscallStubs {}));
            });
        }
